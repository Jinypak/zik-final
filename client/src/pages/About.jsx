        ...
        <div>
            ...
            <div className="box">
                <p>
                    ...
                    '회사'라고 함)는 『개인정보 보호법』 및 『정보통신망
                    이용촉진 및 정보보호 등에 관한 법률』(이하
                    ‘정보통신망법’이라고 함)을 포함하는 개인정보 관련법령에 따라
                    고객의 개인정보 및 권익을 보호하고, 고객이 제공하는
                    개인정보가 어떠한 용도와 방식으로 이용되는지 알려드리고자
                    다음과 같은 개인정보 처리방침을 마련하고 있습니다. 회사는
                    관련 법령 및 지침의 변경 또는 내부 운영방침의 변경에 따라
                    수시로 개인정보 처리방침을 개정할 수 있으며, 이러한 경우
                    웹사이트 공지사항(또는 개별통지)을 통하여 변경내용을 공지할
                    것입니다.
                </p>
                <ul>
